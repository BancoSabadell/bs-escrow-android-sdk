...
import static com.sabadell.bsescrow.Raw.clearCache;
...
public final class IntegrationTest {
  ...
  @Rule public ActivityTestRule<EscrowActivity> mActivityRule =
      new ActivityTestRule<>(EscrowActivity.class);
  ...
  @Test public void _a01_Precondition_Cash_Out() {
    clearCache();
  }

  @Test public void _a02_Verify_cashIn_Buyer() {
    cashIn(amount);
  }
