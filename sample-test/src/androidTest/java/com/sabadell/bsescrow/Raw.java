...
final class Raw {
  private static final String PASSWORD = "dummy_password",
      ADDRESS_BUYER = "0xe26124c8a5c4c747a794eb6abbc9aeb7a5ef2fd7",
      ADDRESS_SELLER = "0xe26124c8a5c4c747a794eb6abbc9aeb7a5ef2fd7";
  ...
  static void balanceAddressBuyer(String expectedAmount) {
    onView(withId(et_address_buyer)).perform(replaceText(ADDRESS_BUYER), closeSoftKeyboard());

    onView(withId(R.id.bt_balance_of_buyer)).perform(click());
  ...
  static void createEscrow(String assetPrice, String assetId) {
    ...
    onView(withId(R.id.bt_create_escrow)).perform(click());
  ...
  static void stateEscrow(String idAsset, String state) {
    ...
    onView(withId(R.id.bt_state_escrow)).perform(click());
  ...
  static void cancelEscrowProposal(String idAsset) {
    ...
    onView(withId(R.id.bt_cancel_escrow_proposal)).perform(click());
  ...
  static void validateCancelEscrowProposal(String idAsset, boolean valid) {
    ...
    if (valid) onView(withId(R.id.cb_validate)).perform(click());

    onView(withId(R.id.bt_validate_cancel_escrow_proposal)).perform(click());
  ...
  static void cancelEscrowArbitrating(String idAsset) {
    ...
    onView(withId(R.id.bt_cancel_escrow_arbitrating)).perform(click());
    onView(withId(R.id.tv_output)).check(matches(withText(R.string.success)));
    waitTime();
  }
  ...
  static void cancelEscrow(String idAsset) {
    ...
    onView(withId(R.id.bt_cancel_escrow)).perform(click());
    onView(withId(R.id.tv_output)).check(matches(withText(R.string.success)));
    waitTime();
  }
  ...
  static void fulfillEscrowArbitrating(String idAsset) {
    ...
    onView(withId(R.id.bt_fulfill_escrow_arbitrating)).perform(click());
    onView(withId(R.id.tv_output)).check(matches(withText(R.string.success)));
    waitTime();
  }
  ...
  static void fulfillEscrow(String idAsset) {
    ...
    onView(withId(R.id.bt_fulfill_escrow)).perform(click());
    onView(withId(R.id.tv_output)).check(matches(withText(R.string.success)));
    waitTime();
  }
